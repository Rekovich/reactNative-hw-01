  ...
  return (
    <CommentsTabs.Navigator
      ...
      screenOptions={{
        ...
        tabBarStyle: { height: 90, borderBottomColor: "#E8E8E8", borderBottomWidth: 1, alignItems: "center", justifyContent: "center" },
      }}
    >
      <CommentsTabs.Screen
        options={{
          tabBarIcon: () => {
            return (
              <View style={styles.barStyle}>
                ...
                ></TextInput>
                <TouchableOpacity style={styles.addButton} activeOpacity={0.5} onPress={setComment}>
